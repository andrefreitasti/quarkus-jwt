package com.fsfx.quarkusjwt.model;
...
public class User {
	...
	public static User findByUsername(String username) {
		...
		//username:passwowrd -> user:user -> senha: senha -> Trocar a senha: System.out.print(passwordEncoder.encode("senha"))
		data.put("user", new User("user", "Nxu45FsQDBv3mS7pon3mLrefOvqjiasjW+Zi7v+TuyA=", Collections.singleton(Role.USER)));
